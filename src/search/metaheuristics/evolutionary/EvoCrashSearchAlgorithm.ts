...
import { MOSA, EncodingSampler, EncodingRunner, Crossover, EvolutionaryAlgorithm, getUserInterface, crowdingDistance, ObjectiveFunction, Encoding, DominanceComparator, SearchSubject, BudgetManager, TerminationManager, Archive } from "@syntest/core";
import {StackTraceObjectiveManager} from "../../objective/managers/StackTraceObjectiveManager";
 ...
 */
export class EvoCrashSearchAlgorithm<T extends Encoding> extends EvolutionaryAlgorithm<T> {
    constructor(
        encodingSampler: EncodingSampler<T>,
        runner: EncodingRunner<T>,
        crossover: Crossover<T>
    ) {
        super(new StackTraceObjectiveManager<T>(runner), encodingSampler, crossover);
    }
