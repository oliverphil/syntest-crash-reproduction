const Readable = require("../../benchmark/crashes/seeded/atom/atom-22894-1/node_modules/readable-stream/lib/_stream_readable.js");
...
describe('_stream_readable', () => {
	...
	it('test for _stream_readable', async () => {
		const _Readable_object_KQew = new Readable()
		const _ev_boolean_isnR = true;
		const _fn_array_kjwz = []
		const _on_function_OzHS = await _Readable_object_KQew.on(_ev_boolean_isnR, _fn_array_kjwz)
